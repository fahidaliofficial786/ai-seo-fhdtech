...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        title: "AI SEO Audit — SEO Scanner for AI-Generated Websites | FHDTech",
      },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "AI SEO Audit Platform — FHDTech" },
      {
        ...
        content:
          "The world's most comprehensive SEO audit platform built for AI-generated websites. 100+ checks across SEO, AI search, performance, security & accessibility.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "AI SEO Audit — FHDTech" },
      { property: "og:image", content: "https://aiseo.fhdtech.com/og-image.jpg" },
      { name: "twitter:image", content: "https://aiseo.fhdtech.com/og-image.jpg" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@fahidali0" },
    ],
    links: [
      {
        rel: "stylesheet",
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "AI website SEO audit platform helping AI-generated websites rank in Google and AI search.",
          sameAs: [
      ...
      },
      {
        ...
        children: `
          ...
          })(window, document, "clarity", "script", "xn7rbzag6n");
        `,
      },
    ],
  }),
